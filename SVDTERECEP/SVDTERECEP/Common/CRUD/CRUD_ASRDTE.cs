...
namespace SVDTERECEP.Common.CRUD
{
        ...
        public void AddASRDTE(ASRDTE aSRDTE)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(Code))
                {
                    ...
                    oGeneralParams.SetProperty("Code", aSRDTE.Code);
                    try
                    {
                        oGeneralData = oGeneralService.GetByParams(oGeneralParams);
                        Code = oGeneralData.GetProperty("Code").ToString();
                    }
                    catch { Code = null; }
                }
                if (string.IsNullOrEmpty(Code))
                {
                    ...
                    try
                    {
                        try
                        {
                            ...
                            oDocGeneralData.SetProperty("Code", aSRDTE.Code);
